...
return ['colors' => ['primary' => ['bg' => '#855785', 'text' => '#ffffff'], 'header' => ['bg' => '#F5F4F4', 'text' => '#676767', 'durationbg' => '#eeeeee'], 'body' => [
    'bg' => '#ffffff',
    //calendar_bg
    'text' => '#505050',
    //calendar_cotext
    'disabled_links' => '#cccccc',
], 'selected_day' => [
    'bg' => '#a0a0a0',
    //back_bg
    'text' => '#ffffff',
    ...
    //error_co
    'payment' => '#f7f7f7',
], 'address' => ['bg' => '#e6e6e6', 'text' => '#606060'], 'confirmation' => [
    'bg' => '#82ca9c',
    //header_bg
    'text' => '#ffffff',
