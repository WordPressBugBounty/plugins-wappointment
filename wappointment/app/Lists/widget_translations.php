...
return [
    'a_is_video' => __('Appointment is a Video meeting', 'wappointment'),
    'a_with_videolink' => __('Meeting will be accessible from the link below:', 'wappointment'),
    'a_is_phone' => __('Appointment over the phone.', 'wappointment'),
