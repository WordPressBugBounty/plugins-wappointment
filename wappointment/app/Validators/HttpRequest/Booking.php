...
class Booking extends \Wappointment\Validators\HttpRequest\LegacyBooking
{
    ...
    {
        $this->validationRulesArray = [static::$startKey => 'required|min:' . $this->getTimeMin(), 'ctz' => '', 'location' => 'required|min:1', 'service' => 'required|min:1', 'duration' => 'required|min:5', 'staff_id' => '', 'package_id' => '', 'package_price_id' => '', 'slots' => '', 'appointment_key' => ''];
