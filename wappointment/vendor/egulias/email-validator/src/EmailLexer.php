...
use WappoVendor\Doctrine\Common\Lexer\AbstractLexer;
...
class EmailLexer extends AbstractLexer
{
    ...
    public function moveNext(): bool
    {
        ...
        $this->previous = $this->token instanceof Token ? ['value' => $this->token->value, 'type' => $this->token->type, 'position' => $this->token->position] : $this->token;
