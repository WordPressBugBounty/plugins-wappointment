...
use WappoVendor\GuzzleHttp\Psr7\Response as Psr7Response;
 ...
 * @method \Illuminate\Http\Client\Response \WappointmentLv::head(string $url, array|string|null $query = null)
...
class Factory
{
    ...
    public function __construct(Dispatcher $dispatcher = null)
    {
        ...
        $this->stubCallbacks = \WappointmentLv::collect();
    }
    /**
    ...
    public function stubUrl($url, $callback)
    {
        return $this->fake(function ($request, $options) use ($url, $callback) {
            ...
            return $callback instanceof Closure || $callback instanceof ResponseSequence ? $callback($request, $options) : $callback;
        });
    }
    /**
    ...
    {
        PHPUnit::assertTrue($this->recorded($callback)->count() > 0, 'An expected request was not recorded.');
    }
    /**
    ...
    {
        PHPUnit::assertFalse($this->recorded($callback)->count() > 0, 'Unexpected request was recorded.');
    }
    /**
    ...
    public function __call($method, $parameters)
    {
        ...
        return \WappointmentLv::tap($this->newPendingRequest(), function ($request) {
