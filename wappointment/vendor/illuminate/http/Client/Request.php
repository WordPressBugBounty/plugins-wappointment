...
class Request implements ArrayAccess
{
    ...
    {
        return $this->hasHeader('Content-Type') && Str::contains($this->header('Content-Type')[0], 'json');
    }
    /**
    ...
    {
        return $this->hasHeader('Content-Type') && Str::contains($this->header('Content-Type')[0], 'multipart');
    }
    /**
