...
use WappoVendor\Illuminate\Pagination\AbstractCursorPaginator;
...
trait CollectsResources
{
    ...
    protected function collectResource($resource)
    {
        ...
        return $resource instanceof AbstractPaginator || $resource instanceof AbstractCursorPaginator ? $resource->setCollection($this->collection) : $this->collection;
    }
    /**
    ...
    public function jsonOptions()
    {
        ...
        return (new ReflectionClass($collects))->newInstanceWithoutConstructor()->jsonOptions();
    }
    /**
