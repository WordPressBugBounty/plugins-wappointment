...
namespace WappoVendor\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use WappoVendor\Illuminate\Contracts\Container\BindingResolutionException;
use WappoVendor\Illuminate\Contracts\Container\CircularDependencyException;
use WappoVendor\Illuminate\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
