...
use WappoVendor\Doctrine\DBAL\Connection as DoctrineConnection;
use WappoVendor\Doctrine\DBAL\Types\Type;
use Exception;
use WappoVendor\Illuminate\Contracts\Events\Dispatcher;
use WappoVendor\Illuminate\Database\Events\QueryExecuted;
use WappoVendor\Illuminate\Database\Events\StatementPrepared;
use WappoVendor\Illuminate\Database\Events\TransactionBeginning;
use WappoVendor\Illuminate\Database\Events\TransactionCommitted;
use WappoVendor\Illuminate\Database\Events\TransactionRolledBack;
use WappoVendor\Illuminate\Database\Query\Builder as QueryBuilder;
use WappoVendor\Illuminate\Database\Query\Expression;
use WappoVendor\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use WappoVendor\Illuminate\Database\Query\Processors\Processor;
use WappoVendor\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return class_exists('WappoVendor\Doctrine\DBAL\Connection');
    }
    /**
