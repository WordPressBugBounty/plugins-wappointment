...
namespace WappoVendor\Illuminate\Database\Migrations;
...
use WappoVendor\Illuminate\Database\Events\MigrationEnded;
use WappoVendor\Illuminate\Database\Events\MigrationsEnded;
use WappoVendor\Illuminate\Database\Events\MigrationsStarted;
use WappoVendor\Illuminate\Database\Events\MigrationStarted;
use WappoVendor\Illuminate\Database\Events\NoPendingMigrations;
...
class Migrator
{
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = \false)
    {
        ...
        $migrations = \WappointmentLv::collect($migrations)->map(function ($m) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \WappointmentLv::tap($callback(), function () use ($previousConnection) {
