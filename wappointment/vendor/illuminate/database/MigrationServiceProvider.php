...
use WappoVendor\Illuminate\Contracts\Support\DeferrableProvider;
use WappoVendor\Illuminate\Database\Console\Migrations\FreshCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\InstallCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\MigrateCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\MigrateMakeCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\RefreshCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\ResetCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\RollbackCommand;
use WappoVendor\Illuminate\Database\Console\Migrations\StatusCommand;
