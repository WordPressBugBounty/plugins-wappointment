...
use WappoVendor\Illuminate\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
    ...
    {
        return \WappointmentLv::collect($this->commands)->filter(function ($command) use ($names) {
    ...
    {
        return \WappointmentLv::collect($this->commands)->contains(function ($command) {
    ...
    {
        return $this->float($column, $total, $places, \true);
    }
    /**
    ...
    {
        return $this->double($column, $total, $places, \true);
    }
    /**
    ...
    {
        return $this->decimal($column, $total, $places, \true);
    }
    /**
    ...
    {
        return !is_null(\WappointmentLv::collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return \WappointmentLv::collect($this->getAddedColumns())->mapWithKeys(function ($column) {
