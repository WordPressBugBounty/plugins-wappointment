...
use WappoVendor\Illuminate\Support\ConfigurationUrlParser;
...
class DatabaseManager implements ConnectionResolverInterface
{
    ...
    {
        if (!class_exists('WappoVendor\Doctrine\DBAL\Connection')) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \WappointmentLv::tap($callback(), function () use ($previousName) {
