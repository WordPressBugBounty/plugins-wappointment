...
use WappoVendor\Illuminate\Broadcasting\InteractsWithSockets;
use WappoVendor\Illuminate\Broadcasting\PrivateChannel;
use WappoVendor\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use WappoVendor\Illuminate\Queue\SerializesModels;
class BroadcastableModelEventOccurred implements ShouldBroadcast
{
    ...
    public function broadcastOn()
    {
        ...
        return \WappointmentLv::collect($channels)->map(function ($channel) {
    ...
    {
        $default = \WappointmentLv::class_basename($this->model) . ucfirst($this->event);
