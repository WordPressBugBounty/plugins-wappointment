...
use WappoVendor\Illuminate\Database\Eloquent\RelationNotFoundException;
...
trait QueriesRelationships
{
    ...
    public function whereBelongsTo($related, $relationshipName = null, $boolean = 'and')
    {
        if ($relationshipName === null) {
            $relationshipName = Str::camel(\WappointmentLv::class_basename($related));
        }
        try {
        ...
        $this->where($relationship->getQualifiedForeignKeyName(), '=', $related->getAttributeValue($relationship->getOwnerKeyName()), $boolean);
        return $this;
    }
    /**
