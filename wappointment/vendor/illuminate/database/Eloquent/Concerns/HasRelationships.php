...
use Closure;
use WappoVendor\Illuminate\Database\ClassMorphViolationException;
...
use WappoVendor\Illuminate\Database\Eloquent\Relations\BelongsTo;
use WappoVendor\Illuminate\Database\Eloquent\Relations\BelongsToMany;
use WappoVendor\Illuminate\Database\Eloquent\Relations\HasMany;
use WappoVendor\Illuminate\Database\Eloquent\Relations\HasManyThrough;
use WappoVendor\Illuminate\Database\Eloquent\Relations\HasOne;
use WappoVendor\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use WappoVendor\Illuminate\Database\Eloquent\Relations\MorphMany;
use WappoVendor\Illuminate\Database\Eloquent\Relations\MorphOne;
use WappoVendor\Illuminate\Database\Eloquent\Relations\MorphTo;
use WappoVendor\Illuminate\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
    ...
    public function morphedByMany($related, $name, $table = null, $foreignPivotKey = null, $relatedPivotKey = null, $parentKey = null, $relatedKey = null)
    {
        ...
        return $this->morphToMany($related, $name, $table, $foreignPivotKey, $relatedPivotKey, $parentKey, $relatedKey, \true);
    }
    /**
    ...
    public function joiningTable($related, $instance = null)
    {
        ...
        $segments = [$instance ? $instance->joiningTableSegment() : Str::snake(\WappointmentLv::class_basename($related)), $this->joiningTableSegment()];
    ...
    {
        return Str::snake(\WappointmentLv::class_basename($this));
    }
    /**
    ...
    {
        return \WappointmentLv::tap(new $class(), function ($instance) {
