...
namespace WappoVendor\Illuminate\Database\Eloquent\Factories;
...
class Sequence implements Countable
{
    ...
    {
        return \WappointmentLv::tap(\WappointmentLv::value($this->sequence[$this->index % $this->count], $this), function () {
