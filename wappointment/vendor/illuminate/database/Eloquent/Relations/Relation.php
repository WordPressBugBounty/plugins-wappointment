...
abstract class Relation
{
    ...
    {
        return \WappointmentLv::collect($models)->map(function ($value) use ($key) {
    ...
    {
        return $model->getKeyName() === \WappointmentLv::last(explode('.', $key)) && in_array($model->getKeyType(), ['int', 'integer']) ? 'whereIntegerInRaw' : 'whereIn';
    }
    /**
