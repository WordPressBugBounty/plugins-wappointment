...
use WappoVendor\Illuminate\Contracts\Support\MessageBag as MessageBagContract;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
    ...
    {
        return \WappointmentLv::collect($this->messages)->filter(function ($messages, $messageKey) use ($key) {
    ...
    {
        return \WappointmentLv::collect((array) $messages)->map(function ($message) use ($format, $messageKey) {
