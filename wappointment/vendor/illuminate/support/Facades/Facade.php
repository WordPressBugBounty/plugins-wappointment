...
use Closure;
use WappoVendor\Mockery;
use WappoVendor\Mockery\LegacyMockInterface;
...
abstract class Facade
{
    ...
    public static function spy()
    {
        if (!static::isMock()) {
            ...
            return \WappointmentLv::tap($class ? Mockery::spy($class) : Mockery::spy(), function ($spy) {
                static::swap($spy);
            });
        }
    }
    ...
    {
        return \WappointmentLv::tap(static::createMock(), function ($mock) {
            static::swap($mock);
