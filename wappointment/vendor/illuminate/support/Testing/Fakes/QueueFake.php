...
use Closure;
use WappoVendor\Illuminate\Contracts\Queue\Queue;
use WappoVendor\Illuminate\Queue\QueueManager;
...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return \WappointmentLv::collect($this->jobs[$job])->filter(function ($data) use ($callback) {
    ...
    {
        return \WappointmentLv::collect($this->jobs)->flatten(1)->filter(function ($job) use ($queue) {
