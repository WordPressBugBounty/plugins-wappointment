...
class EventFake implements Dispatcher
{
    ...
    public function dispatched($event, $callback = null)
    {
        ...
        return \WappointmentLv::collect($this->events[$event])->filter(function ($arguments) use ($callback) {
    ...
    protected function shouldFakeEvent($eventName, $payload)
    {
        ...
        return \WappointmentLv::collect($this->eventsToFake)->filter(function ($event) use ($eventName, $payload) {
