...
use WappoVendor\League\CommonMark\GithubFlavoredMarkdownConverter;
use WappoVendor\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use WappoVendor\Ramsey\Uuid\Generator\CombGenerator;
use WappoVendor\Ramsey\Uuid\Uuid;
use WappoVendor\Ramsey\Uuid\UuidFactory;
use WappoVendor\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**
    ...
    public static function matchAll($pattern, $subject)
    {
        ...
        return \WappointmentLv::collect($matches[1] ?? $matches[0]);
    }
    /**
