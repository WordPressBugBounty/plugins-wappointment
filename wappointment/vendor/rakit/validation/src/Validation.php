...
use Closure;
use WappoVendor\Rakit\Validation\Rules\Interfaces\BeforeValidate;
use WappoVendor\Rakit\Validation\Rules\Interfaces\ModifyValue;
    ...
    protected function resolveRules($rules): array
    {
        ...
        foreach ($rules as $i => $rule) {
            ...
            if (is_string($rule)) {
                ...
                $validator = call_user_func_array($validatorFactory, ['WappoVendor\callback', $rule]);
            } else {
