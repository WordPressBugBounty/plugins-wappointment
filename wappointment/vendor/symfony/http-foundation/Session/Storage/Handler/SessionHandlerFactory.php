 ...
 */
namespace WappoVendor\Symfony\Component\HttpFoundation\Session\Storage\Handler;

use WappoVendor\Doctrine\DBAL\DriverManager;
use WappoVendor\Symfony\Component\Cache\Adapter\AbstractAdapter;
use WappoVendor\Symfony\Component\Cache\Traits\RedisClusterProxy;
use WappoVendor\Symfony\Component\Cache\Traits\RedisProxy;
/**
...
class SessionHandlerFactory
{
    ...
    public static function createHandler($connection): AbstractSessionHandler
    {
        ...
        switch (\true) {
            ...
            case $connection instanceof \WappoVendor\Predis\ClientInterface:
