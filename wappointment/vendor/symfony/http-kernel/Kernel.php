...
use WappoVendor\Symfony\Bridge\ProxyManager\LazyProxy\Instantiator\RuntimeInstantiator;
use WappoVendor\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper\ProxyDumper;
use WappoVendor\Symfony\Component\Config\Builder\ConfigBuilderGenerator;
use WappoVendor\Symfony\Component\Config\ConfigCache;
use WappoVendor\Symfony\Component\Config\Loader\DelegatingLoader;
use WappoVendor\Symfony\Component\Config\Loader\LoaderResolver;
use WappoVendor\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use WappoVendor\Symfony\Component\DependencyInjection\Compiler\PassConfig;
...
use WappoVendor\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
use WappoVendor\Symfony\Component\DependencyInjection\Dumper\Preloader;
use WappoVendor\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\DirectoryLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\GlobFileLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
use WappoVendor\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
use WappoVendor\Symfony\Component\ErrorHandler\DebugClassLoader;
use WappoVendor\Symfony\Component\Filesystem\Filesystem;
use WappoVendor\Symfony\Component\HttpFoundation\Request;
use WappoVendor\Symfony\Component\HttpFoundation\Response;
use WappoVendor\Symfony\Component\HttpKernel\Bundle\BundleInterface;
use WappoVendor\Symfony\Component\HttpKernel\CacheWarmer\WarmableInterface;
use WappoVendor\Symfony\Component\HttpKernel\Config\FileLocator;
use WappoVendor\Symfony\Component\HttpKernel\DependencyInjection\AddAnnotatedClassesToCachePass;
use WappoVendor\Symfony\Component\HttpKernel\DependencyInjection\MergeExtensionConfigurationPass;
...
abstract class Kernel implements KernelInterface, RebootableInterface, TerminableInterface
{
    ...
    protected function getContainerBuilder()
    {
        ...
        if (class_exists(\WappoVendor\ProxyManager\Configuration::class) && class_exists(RuntimeInstantiator::class)) {
    ...
    protected function dumpContainer(ConfigCache $cache, ContainerBuilder $container, string $class, string $baseClass)
    {
        ...
        if (class_exists(\WappoVendor\ProxyManager\Configuration::class) && class_exists(ProxyDumper::class)) {
    ...
    {
        if (!\function_exists('token_get_all') && !\function_exists('WappoVendor\token_get_all')) {
            return $source;
        }
        $rawChunk = '';
        $output = '';
