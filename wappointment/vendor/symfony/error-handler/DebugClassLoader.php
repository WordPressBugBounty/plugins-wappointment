...
use WappoVendor\Composer\InstalledVersions;
use WappoVendor\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use WappoVendor\Doctrine\Persistence\Proxy;
use WappoVendor\Mockery\MockInterface;
use WappoVendor\Phake\IMock;
use WappoVendor\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use WappoVendor\PHPUnit\Framework\MockObject\MockObject;
use WappoVendor\Prophecy\Prophecy\ProphecySubjectInterface;
use WappoVendor\ProxyManager\Proxy\ProxyInterface;
use WappoVendor\Symfony\Component\ErrorHandler\Internal\TentativeTypes;
/**
