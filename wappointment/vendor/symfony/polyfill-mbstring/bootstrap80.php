 ...
 */
use WappoVendor\Symfony\Polyfill\Mbstring as p;
if (!\function_exists('mb_convert_encoding') && !\function_exists('WappoVendor\mb_convert_encoding')) {
...
if (!\function_exists('mb_decode_mimeheader') && !\function_exists('WappoVendor\mb_decode_mimeheader')) {
    function mb_decode_mimeheader(?string $string): string
    {
        return p\Mbstring::mb_decode_mimeheader((string) $string);
    }
}
if (!\function_exists('mb_encode_mimeheader') && !\function_exists('WappoVendor\mb_encode_mimeheader')) {
...
if (!\function_exists('mb_decode_numericentity') && !\function_exists('WappoVendor\mb_decode_numericentity')) {
...
if (!\function_exists('mb_encode_numericentity') && !\function_exists('WappoVendor\mb_encode_numericentity')) {
...
if (!\function_exists('mb_convert_case') && !\function_exists('WappoVendor\mb_convert_case')) {
...
if (!\function_exists('mb_internal_encoding') && !\function_exists('WappoVendor\mb_internal_encoding')) {
    function mb_internal_encoding(?string $encoding = null): string|bool
    {
        return p\Mbstring::mb_internal_encoding($encoding);
    }
}
if (!\function_exists('mb_language') && !\function_exists('WappoVendor\mb_language')) {
    function mb_language(?string $language = null): string|bool
    {
        return p\Mbstring::mb_language($language);
    }
}
if (!\function_exists('mb_list_encodings') && !\function_exists('WappoVendor\mb_list_encodings')) {
    function mb_list_encodings(): array
    {
        return p\Mbstring::mb_list_encodings();
    }
}
if (!\function_exists('mb_encoding_aliases') && !\function_exists('WappoVendor\mb_encoding_aliases')) {
    function mb_encoding_aliases(?string $encoding): array
    {
        return p\Mbstring::mb_encoding_aliases((string) $encoding);
    }
}
if (!\function_exists('mb_check_encoding') && !\function_exists('WappoVendor\mb_check_encoding')) {
...
if (!\function_exists('mb_detect_encoding') && !\function_exists('WappoVendor\mb_detect_encoding')) {
    function mb_detect_encoding(?string $string, array|string|null $encodings = null, ?bool $strict = \false): string|false
    {
        return p\Mbstring::mb_detect_encoding((string) $string, $encodings, (bool) $strict);
    }
}
if (!\function_exists('mb_detect_order') && !\function_exists('WappoVendor\mb_detect_order')) {
    function mb_detect_order(array|string|null $encoding = null): array|bool
    {
        return p\Mbstring::mb_detect_order($encoding);
    }
}
if (!\function_exists('mb_parse_str') && !\function_exists('WappoVendor\mb_parse_str')) {
...
if (!\function_exists('mb_strlen') && !\function_exists('WappoVendor\mb_strlen')) {
    function mb_strlen(?string $string, ?string $encoding = null): int
    {
        return p\Mbstring::mb_strlen((string) $string, $encoding);
    }
}
if (!\function_exists('mb_strpos') && !\function_exists('WappoVendor\mb_strpos')) {
...
if (!\function_exists('mb_strtolower') && !\function_exists('WappoVendor\mb_strtolower')) {
    function mb_strtolower(?string $string, ?string $encoding = null): string
    {
        return p\Mbstring::mb_strtolower((string) $string, $encoding);
    }
}
if (!\function_exists('mb_strtoupper') && !\function_exists('WappoVendor\mb_strtoupper')) {
    function mb_strtoupper(?string $string, ?string $encoding = null): string
    {
        return p\Mbstring::mb_strtoupper((string) $string, $encoding);
    }
}
if (!\function_exists('mb_substitute_character') && !\function_exists('WappoVendor\mb_substitute_character')) {
...
if (!\function_exists('mb_substr') && !\function_exists('WappoVendor\mb_substr')) {
    function mb_substr(?string $string, ?int $start, ?int $length = null, ?string $encoding = null): string
    {
        return p\Mbstring::mb_substr((string) $string, (int) $start, $length, $encoding);
    }
}
if (!\function_exists('mb_stripos') && !\function_exists('WappoVendor\mb_stripos')) {
...
if (!\function_exists('mb_stristr') && !\function_exists('WappoVendor\mb_stristr')) {
...
if (!\function_exists('mb_strrchr') && !\function_exists('WappoVendor\mb_strrchr')) {
...
if (!\function_exists('mb_strrichr') && !\function_exists('WappoVendor\mb_strrichr')) {
...
if (!\function_exists('mb_strripos') && !\function_exists('WappoVendor\mb_strripos')) {
...
if (!\function_exists('mb_strrpos') && !\function_exists('WappoVendor\mb_strrpos')) {
...
if (!\function_exists('mb_strstr') && !\function_exists('WappoVendor\mb_strstr')) {
...
if (!\function_exists('mb_get_info') && !\function_exists('WappoVendor\mb_get_info')) {
    function mb_get_info(?string $type = 'all'): array|string|int|false
    {
        return p\Mbstring::mb_get_info((string) $type);
    }
}
if (!\function_exists('mb_http_output') && !\function_exists('WappoVendor\mb_http_output')) {
    function mb_http_output(?string $encoding = null): string|bool
    {
        return p\Mbstring::mb_http_output($encoding);
    }
}
if (!\function_exists('mb_strwidth') && !\function_exists('WappoVendor\mb_strwidth')) {
    function mb_strwidth(?string $string, ?string $encoding = null): int
    {
        return p\Mbstring::mb_strwidth((string) $string, $encoding);
    }
}
if (!\function_exists('mb_substr_count') && !\function_exists('WappoVendor\mb_substr_count')) {
...
if (!\function_exists('mb_output_handler') && !\function_exists('WappoVendor\mb_output_handler')) {
    function mb_output_handler(?string $string, ?int $status): string
    {
        return p\Mbstring::mb_output_handler((string) $string, (int) $status);
    }
}
if (!\function_exists('mb_http_input') && !\function_exists('WappoVendor\mb_http_input')) {
    function mb_http_input(?string $type = null): array|string|false
    {
        return p\Mbstring::mb_http_input($type);
    }
}
if (!\function_exists('mb_convert_variables') && !\function_exists('WappoVendor\mb_convert_variables')) {
...
if (!\function_exists('mb_str_split') && !\function_exists('WappoVendor\mb_str_split')) {
