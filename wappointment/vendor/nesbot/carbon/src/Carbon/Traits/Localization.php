 ...
 */
namespace WappoVendor\Carbon\Traits;

use WappoVendor\Carbon\CarbonInterface;
use WappoVendor\Carbon\Exceptions\InvalidTypeException;
use WappoVendor\Carbon\Exceptions\NotLocaleAwareException;
use WappoVendor\Carbon\Language;
use WappoVendor\Carbon\Translator;
use WappoVendor\Carbon\TranslatorStrongTypeInterface;
use Closure;
use WappoVendor\Symfony\Component\Translation\TranslatorBagInterface;
...
use WappoVendor\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
if (interface_exists('WappoVendor\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('WappoVendor\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('WappoVendor\Symfony\Contracts\Translation\TranslatorInterface', 'WappoVendor\Symfony\Component\Translation\TranslatorInterface');
}
/**
 * Trait Localization.
 *
