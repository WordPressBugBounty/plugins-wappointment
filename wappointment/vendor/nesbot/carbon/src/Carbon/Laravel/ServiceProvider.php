...
use WappoVendor\Carbon\CarbonInterval;
use WappoVendor\Carbon\CarbonPeriod;
use WappoVendor\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use WappoVendor\Illuminate\Events\Dispatcher;
use WappoVendor\Illuminate\Events\EventDispatcher;
use WappoVendor\Illuminate\Support\Carbon as IlluminateCarbon;
...
class ServiceProvider extends \WappoVendor\Illuminate\Support\ServiceProvider
{
    ...
    {
        return \function_exists('WappoVendor\app') ? \WappoVendor\app(...$args) : null;
    }
