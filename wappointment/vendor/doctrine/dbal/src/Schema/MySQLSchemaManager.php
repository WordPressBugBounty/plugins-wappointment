...
use WappoVendor\Doctrine\DBAL\Platforms\MySQL;
use WappoVendor\Doctrine\DBAL\Platforms\MySQL\CollationMetadataProvider\CachingCollationMetadataProvider;
use WappoVendor\Doctrine\DBAL\Platforms\MySQL\CollationMetadataProvider\ConnectionCollationMetadataProvider;
...
class MySQLSchemaManager extends AbstractSchemaManager
{
    ...
    protected function _getPortableTableForeignKeysList($tableForeignKeys)
    {
        ...
        foreach ($list as $constraint) {
            $result[] = new ForeignKeyConstraint($constraint['local'], $constraint['foreignTable'], $constraint['foreign'], $constraint['name'], ['onDelete' => $constraint['onDelete'], 'onUpdate' => $constraint['onUpdate']]);
        }
        return $result;
    }
    /**
