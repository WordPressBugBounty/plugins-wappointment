...
use WappoVendor\Doctrine\Common\EventManager;
use WappoVendor\Doctrine\DBAL\Event\SchemaAlterTableAddColumnEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaAlterTableChangeColumnEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaAlterTableEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaAlterTableRemoveColumnEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaAlterTableRenameColumnEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaCreateTableColumnEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaCreateTableEventArgs;
use WappoVendor\Doctrine\DBAL\Event\SchemaDropTableEventArgs;
use WappoVendor\Doctrine\DBAL\Events;
use WappoVendor\Doctrine\DBAL\Exception;
use WappoVendor\Doctrine\DBAL\Exception\InvalidLockMode;
use WappoVendor\Doctrine\DBAL\LockMode;
use WappoVendor\Doctrine\DBAL\Platforms\Keywords\KeywordList;
use WappoVendor\Doctrine\DBAL\Schema\Column;
use WappoVendor\Doctrine\DBAL\Schema\ColumnDiff;
use WappoVendor\Doctrine\DBAL\Schema\Constraint;
...
use WappoVendor\Doctrine\DBAL\Schema\UniqueConstraint;
use WappoVendor\Doctrine\DBAL\SQL\Parser;
use WappoVendor\Doctrine\DBAL\TransactionIsolationLevel;
use WappoVendor\Doctrine\DBAL\Types;
...
abstract class AbstractPlatform
{
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getSqlCommentStartString() is deprecated.');
        return '--';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getSqlCommentEndString() is deprecated.');
        return "\n";
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getWildcards() is deprecated.' . ' Use AbstractPlatform::getLikeWildcardCharacters() instead.');
        return ['%', '_'];
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getAvgExpression() is deprecated. Use AVG() in SQL instead.');
        return 'AVG(' . $column . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getCountExpression() is deprecated. Use COUNT() in SQL instead.');
        return 'COUNT(' . $column . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getMaxExpression() is deprecated. Use MAX() in SQL instead.');
        return 'MAX(' . $column . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getMinExpression() is deprecated. Use MIN() in SQL instead.');
        return 'MIN(' . $column . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getSumExpression() is deprecated. Use SUM() in SQL instead.');
        return 'SUM(' . $column . ')';
    }
    // scalar functions
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getMd5Expression() is deprecated.');
        return 'MD5(' . $column . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getSqrtExpression() is deprecated. Use SQRT() in SQL instead.');
        return 'SQRT(' . $column . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getRoundExpression() is deprecated. Use ROUND() in SQL instead.');
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getRtrimExpression() is deprecated. Use RTRIM() in SQL instead.');
        return 'RTRIM(' . $str . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getLtrimExpression() is deprecated. Use LTRIM() in SQL instead.');
        return 'LTRIM(' . $str . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getUpperExpression() is deprecated. Use UPPER() in SQL instead.');
        return 'UPPER(' . $str . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getLowerExpression() is deprecated. Use LOWER() in SQL instead.');
        return 'LOWER(' . $str . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getNotExpression() is deprecated. Use NOT() in SQL instead.');
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getIsNullExpression() is deprecated. Use IS NULL in SQL instead.');
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getIsNotNullExpression() is deprecated. Use IS NOT NULL in SQL instead.');
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getBetweenExpression() is deprecated. Use BETWEEN in SQL instead.');
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getAcosExpression() is deprecated. Use ACOS() in SQL instead.');
        return 'ACOS(' . $value . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getSinExpression() is deprecated. Use SIN() in SQL instead.');
        return 'SIN(' . $value . ')';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getPiExpression() is deprecated. Use PI() in SQL instead.');
        return 'PI()';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getCosExpression() is deprecated. Use COS() in SQL instead.');
        return 'COS(' . $value . ')';
    }
    /**
    ...
    public function getColumnDeclarationSQL($name, array $column)
    {
        if (isset($column['columnDefinition'])) {
            ...
            $unique = !empty($column['unique']) ? ' ' . $this->getUniqueFieldDeclarationSQL() : '';
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getTemporaryTableSQL() is deprecated.');
        return 'TEMPORARY';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getUniqueFieldDeclarationSQL() is deprecated. Use UNIQUE in SQL instead.');
        return 'UNIQUE';
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/1519', 'AbstractPlatform::prefersIdentityColumns() is deprecated.');
        return \false;
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::getListUsersSQL() is deprecated.');
        throw Exception::notSupported(__METHOD__);
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsIndexes() is deprecated.');
        return \true;
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsAlterTable() is deprecated. All platforms must implement altering tables.');
        return \true;
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsTransactions() is deprecated.');
        return \true;
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsPrimaryConstraints() is deprecated.');
        return \true;
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsGettingAffectedRows() is deprecated.');
        return \true;
    }
    /**
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsViews() is deprecated. All platforms must implement support for views.');
        return \true;
    }
    /**
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4724', 'AbstractPlatform::supportsViews() is deprecated.' . ' All platforms must implement support for offsets in modify limit clauses.');
        return \true;
    }
    /**
