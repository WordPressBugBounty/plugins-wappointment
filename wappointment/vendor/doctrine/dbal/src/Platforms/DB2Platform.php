...
class DB2Platform extends AbstractPlatform
{
    ...
    {
        $this->doctrineTypeMapping = ['bigint' => 'bigint', 'binary' => 'binary', 'blob' => 'blob', 'character' => 'string', 'clob' => 'text', 'date' => 'date', 'decimal' => 'decimal', 'double' => 'float', 'integer' => 'integer', 'real' => 'float', 'smallint' => 'smallint', 'time' => 'time', 'timestamp' => 'datetime', 'varbinary' => 'binary', 'varchar' => 'string'];
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/5058', '%s is deprecated and will be removed in Doctrine DBAL 4.0. Use Type::requiresSQLCommentHint() instead.', __METHOD__);
    ...
    {
        return $fixed ? $length > 0 ? 'CHAR(' . $length . ')' : 'CHAR(254)' : ($length > 0 ? 'VARCHAR(' . $length . ')' : 'VARCHAR(255)');
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/issues/4749', 'DB2Platform::getName() is deprecated. Identify platforms by their class.');
        return 'db2';
    }
    /**
     * {@inheritDoc}
    ...
    public function getAlterTableSQL(TableDiff $diff)
    {
        ...
        if (!$this->onSchemaAlterTable($diff, $tableSql)) {
            ...
            if ($newName !== \false) {
                $sql[] = sprintf('RENAME TABLE %s TO %s', $diff->getName($this)->getQuotedName($this), $newName->getQuotedName($this));
            }
    ...
    {
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/1519', 'DB2Platform::prefersIdentityColumns() is deprecated.');
        return \true;
    }
    /**
     * {@inheritDoc}
