...
use WappoVendor\Doctrine\DBAL\Driver\Exception\UnknownParameterType;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Exception\FailedReadingStreamOffset;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Exception\NonStreamResourceUsedAsLargeObject;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Exception\StatementError;
...
{
    /** @var string[] */
    private static $paramTypeMap = [ParameterType::ASCII => 's', ParameterType::STRING => 's', ParameterType::BINARY => 's', ParameterType::BOOLEAN => 'i', ParameterType::NULL => 's', ParameterType::INTEGER => 'i', ParameterType::LARGE_OBJECT => 'b'];
    /** @var mysqli_stmt */
    private $stmt;
    /** @var mixed[] */
    private $boundValues;
