...
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Exception\ConnectionFailed;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Exception\HostRequired;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Initializer\Charset;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Initializer\Options;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli\Initializer\Secure;
use mysqli;
...
final class Driver extends AbstractMySQLDriver
{
    ...
    public function connect(array $params)
    {
        ...
        try {
            $success = @$connection->real_connect($host, $params['user'] ?? null, $params['password'] ?? null, $params['dbname'] ?? null, $params['port'] ?? null, $params['unix_socket'] ?? null, $flags);
