...
namespace WappoVendor\Doctrine\DBAL\Driver\IBMDB2;

use WappoVendor\Doctrine\DBAL\Driver\Exception;
use WappoVendor\Doctrine\DBAL\Driver\IBMDB2\Exception\CannotCopyStreamToStream;
use WappoVendor\Doctrine\DBAL\Driver\IBMDB2\Exception\CannotCreateTemporaryFile;
use WappoVendor\Doctrine\DBAL\Driver\IBMDB2\Exception\StatementError;
