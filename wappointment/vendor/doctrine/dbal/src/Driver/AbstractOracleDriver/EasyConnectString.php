...
namespace WappoVendor\Doctrine\DBAL\Driver\AbstractOracleDriver;
...
final class EasyConnectString
{
    ...
    public static function fromConnectionParameters(array $params): self
    {
        ...
        return self::fromArray(['DESCRIPTION' => ['ADDRESS' => ['PROTOCOL' => 'TCP', 'HOST' => $params['host'], 'PORT' => $params['port'] ?? 1521], 'CONNECT_DATA' => $connectData]]);
    }
    /**
     * @param mixed[] $params
     */
