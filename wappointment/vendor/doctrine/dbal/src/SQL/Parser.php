...
namespace WappoVendor\Doctrine\DBAL\SQL;

use WappoVendor\Doctrine\DBAL\SQL\Parser\Exception;
use WappoVendor\Doctrine\DBAL\SQL\Parser\Exception\RegularExpressionError;
