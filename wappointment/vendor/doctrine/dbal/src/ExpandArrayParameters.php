...
use WappoVendor\Doctrine\DBAL\ArrayParameters\Exception\MissingNamedParameter;
use WappoVendor\Doctrine\DBAL\ArrayParameters\Exception\MissingPositionalParameter;
use WappoVendor\Doctrine\DBAL\SQL\Parser\Visitor;
...
final class ExpandArrayParameters implements Visitor
{
    ...
    private function acceptParameter($key, $value): void
    {
        ...
        if ($type !== Connection::PARAM_INT_ARRAY && $type !== Connection::PARAM_STR_ARRAY && $type !== Connection::PARAM_ASCII_STR_ARRAY) {
