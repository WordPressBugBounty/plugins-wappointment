...
use WappoVendor\Doctrine\DBAL\Driver\IBMDB2;
use WappoVendor\Doctrine\DBAL\Driver\Mysqli;
use WappoVendor\Doctrine\DBAL\Driver\OCI8;
use WappoVendor\Doctrine\DBAL\Driver\PDO;
use WappoVendor\Doctrine\DBAL\Driver\SQLSrv;
...
final class DriverManager
{
     ...
     */
    private const DRIVER_MAP = ['pdo_mysql' => PDO\MySQL\Driver::class, 'pdo_sqlite' => PDO\SQLite\Driver::class, 'pdo_pgsql' => PDO\PgSQL\Driver::class, 'pdo_oci' => PDO\OCI\Driver::class, 'oci8' => OCI8\Driver::class, 'ibm_db2' => IBMDB2\Driver::class, 'pdo_sqlsrv' => PDO\SQLSrv\Driver::class, 'mysqli' => Mysqli\Driver::class, 'sqlsrv' => SQLSrv\Driver::class];
    /**
    ...
    private static function createDriver(array $params): Driver
    {
        if (isset($params['driverClass'])) {
            ...
            if ($interfaces === \false || !in_array(Driver::class, $interfaces, \true)) {
