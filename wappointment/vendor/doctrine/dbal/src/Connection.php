...
namespace WappoVendor\Doctrine\DBAL;

use Closure;
use WappoVendor\Doctrine\Common\EventManager;
use WappoVendor\Doctrine\DBAL\Cache\ArrayResult;
use WappoVendor\Doctrine\DBAL\Cache\CacheException;
use WappoVendor\Doctrine\DBAL\Cache\QueryCacheProfile;
use WappoVendor\Doctrine\DBAL\Driver\API\ExceptionConverter;
use WappoVendor\Doctrine\DBAL\Driver\Connection as DriverConnection;
...
use WappoVendor\Doctrine\DBAL\Event\TransactionBeginEventArgs;
use WappoVendor\Doctrine\DBAL\Event\TransactionCommitEventArgs;
use WappoVendor\Doctrine\DBAL\Event\TransactionRollBackEventArgs;
use WappoVendor\Doctrine\DBAL\Exception\ConnectionLost;
use WappoVendor\Doctrine\DBAL\Exception\DriverException;
use WappoVendor\Doctrine\DBAL\Exception\InvalidArgumentException;
use WappoVendor\Doctrine\DBAL\Platforms\AbstractPlatform;
use WappoVendor\Doctrine\DBAL\Query\Expression\ExpressionBuilder;
use WappoVendor\Doctrine\DBAL\Query\QueryBuilder;
use WappoVendor\Doctrine\DBAL\Schema\AbstractSchemaManager;
...
class Connection
{
    ...
    private function getServerVersion()
    {
        ...
        Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/pulls/4750', 'Not implementing the ServerInfoAwareConnection interface in %s is deprecated', get_class($connection));
    ...
    private function needsArrayParameterConversion(array $params, array $types): bool
    {
        ...
        foreach ($types as $type) {
            if ($type === self::PARAM_INT_ARRAY || $type === self::PARAM_STR_ARRAY || $type === self::PARAM_ASCII_STR_ARRAY) {
                return \true;
            }
        }
        return \false;
